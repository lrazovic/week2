...
describe('Custom Tests', function () {
  ...
  it('[assignment] iii. see assignment doc for details', async () => {
    ...
    const alicewithdrawall = utils.parseEther('0.07')
    const aliceEthAddress = '0xd8da6bf26964af9d7eed9e03e53415d37aa96045'
    await transaction({
      tornadoPool,
    ...
    expect(aliceBalance).to.be.equal(alicewithdrawall)
  })
})
